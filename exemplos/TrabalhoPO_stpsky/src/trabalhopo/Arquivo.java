...
public class Arquivo {
    ...
    */
    ...
    {
        int inicio=1, tll=filesize(), fim=tll-1, meio=fim/2, numero;
        Registro aux= new Registro();
        seekArq(meio);
        aux.leDoArq(arquivo);
        numero=aux.getNumero();
	while(numero!=chave.getNumero() && fim>inicio)
	{
		seekArq(meio);
                aux.leDoArq(arquivo);
                numero=aux.getNumero();
    ...
    public void counting()    //laura ARRUMAR
    {
        Registro aux=new Registro();
        Registro aux2=new Registro();
        int num;
...
// cumulativa
    ...
    {
        int i, p, total = filesize(), num, c, j;
