...
public class TrabalhoPO {
    ...
    public String calculaCompInsDir(int tamanho, int tipo)
    {
        if(tipo == 1)
        {
            return String.format("%.2f", tamanho - 1);
        }
        else
            if(tipo == 2)
            {
    ...
    public String calculaMovInsDir(int tamanho, int tipo)
    {
        if(tipo == 1)
        {
            return String.format("%.2f", 3 * (tamanho - 1));
        }
        else
            if(tipo == 2)
            {
